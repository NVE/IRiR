...
RevCap$ld_sum.cost = RevCap$fha_fp_ld_OPEX*y.cb.cpi.l.factor + 
                        RevCap$fha_fp_ld_cens*y.cb.cpi.factor + RevCap$fha_fp_ld_dep.sf*y.cb.cpi.factor +
...
RevCap$rd_sum.cost = RevCap$fha_fp_rd_OPEX*y.cb.cpi.l.factor +
                        ...
                        RevCap$fha_fp_rd_cens*y.cb.cpi.factor + RevCap$fha_fp_rd_dep.sf*y.cb.cpi.factor +
                        RevCap$fha_rd_nl*pnl.rc
#Transmission grid
RevCap$t_sum.cost = RevCap$fha_fp_t_OPEX*y.cb.cpi.l.factor + 
                        RevCap$fha_fp_t_cens*y.cb.cpi.factor + RevCap$fha_fp_t_dep.sf*y.cb.cpi.factor
...
RevCap$ld_cost.RC = RevCap$fha_fp_ld_OPEX*y.cb.cpi.l.factor + 
                        RevCap$fha_fp_ld_cens*y.cb.cpi.factor + RevCap$fha_fp_ld_dep.sf*y.cb.cpi.factor +
                        RevCap$fha_fp_ld_rab.sf*y.cb.cpi.factor*NVE.ir.RC + RevCap$fha_ld_nl*pnl.rc


RevCap$rd_cost.RC = RevCap$fha_fp_rd_OPEX*y.cb.cpi.l.factor +
                        RevCap$fha_fp_rd_cga*y.cb.cpi.l.factor +
                        RevCap$fha_fp_rd_cens*y.cb.cpi.factor + RevCap$fha_fp_rd_dep.sf*y.cb.cpi.factor +
                        RevCap$fha_fp_rd_rab.sf*y.cb.cpi.factor*NVE.ir.RC + RevCap$fha_rd_nl*pnl.rc

RevCap$t_cost.RC = RevCap$fha_fp_t_OPEX*y.cb.cpi.l.factor + 
                        RevCap$fha_fp_t_cens*y.cb.cpi.factor + RevCap$fha_fp_t_dep.sf*y.cb.cpi.factor +
                        RevCap$fha_fp_t_rab.sf*y.cb.cpi.factor*NVE.ir.RC
...
RevCap$lrt_cost.RC.ex.nlR.og.cgaR = round(RevCap$lrt_cost.RC - RevCap$fha_fp_rd_cga - RevCap$fha_rd_nl*pnl.rc, digits = 0)
...
RevCap = within(RevCap, ld_cn.cal.RAB[is.na(ld_cn.cal.RAB)==TRUE & fha_fp_ld_OPEX == 0] <- 0)
RevCap = within(RevCap, rd_cn.cal.RAB[is.na(rd_cn.cal.RAB)==TRUE & fha_fp_rd_OPEX == 0] <- 0)
...
RevCap$ld_cn.pre.recal = RevCap$ld_cn.cal.RAB + (RevCap$fha_fp_ld_gci.cost*y.cb.cpi.factor)
RevCap$rd_cn.pre.recal = RevCap$rd_cn.cal.RAB + (RevCap$fha_rd_nl*pnl.rc) +
                            RevCap$fha_fp_rd_cga*y.cb.cpi.l.factor
...
#Sum self-funded assets for all companies
RevCap$lrt_RAB.sf = RevCap$fha_fp_ld_rab.sf + RevCap$fha_fp_rd_rab.sf + RevCap$fha_fp_t_rab.sf
...
RevCap$lrt_RET.pre.recal = RevCap$lrt_EBIT.pre.recal / (RevCap$fha_fp_ld_rab.sf + RevCap$fha_fp_rd_rab.sf + RevCap$fha_fp_t_rab.sf) 

# Re-calibration is not considered in Harmonyincome calculation as it will converge to zero over time.
#### Re-Calibration ####
