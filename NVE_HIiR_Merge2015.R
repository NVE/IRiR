...
# Comp 1 
merg.comp1 = c(981963849) # EIDSIVA NETT AS
# Comp 2
merg.comp2 = c(980343278) # ELVERUM NETT AS


merg.comps = c(merg.comp1, merg.comp2)

comp.name = c("Eidisva Nett AS - fusjonert med Elverum")
...
fusjon_Glitre = c(880340492, 979933134 , 981915550) # HADELAND ENERGINETT AS, Lier Everk AS, EB Nett
...
source("./R-script/Harmony/H_0_1_Config_Assumptions_Data_Merge2015.R")
